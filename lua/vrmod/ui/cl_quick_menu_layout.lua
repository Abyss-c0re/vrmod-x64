...
local NAME_TO_ID = {
	...
	["RESPAWN"] = "respawn",
	["VR EXIT"] = "vr_exit",
	["Cube Launcher"] = "cube_launcher",
	["Return to Launcher"] = "cube_launcher",
		...
		pages = {
			...
			},
			{
				...
				items = {
					...
					{ id = "pause_menu", col = 1, row = 0 },
					{ id = "newgame", col = 2, row = 0 },
					{ id = "video_cal", col = 3, row = 0 },
					{ id = "bindings", col = 4, row = 0 },
					{ id = "weapon_vr", col = 5, row = 0 },
					...
					{ id = "disconnect", col = 3, row = 2 },
					{ id = "exit_game", col = 4, row = 2 },
					{ id = "fbt_calibrate", col = 5, row = 2 },
					{ id = "fbt_disable", col = 0, row = 3 },
				},
			},
		},
