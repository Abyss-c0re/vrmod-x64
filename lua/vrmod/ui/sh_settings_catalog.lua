...
vrmod.SettingsCatalog = {
	...
	},
	{
		...
		rows = {
			...
			{ kind = "combo", label = "Follow-cam target", cvar = "vrmod_desktop_cam_mode", choices = {
				...
				{ text = "broadcast module only", value = 2 },
			}},
			...
			{ kind = "bool", label = "Follow-cam wall zoom (anti-clip)", cvar = "vrmod_desktop_cam_collide" },
			{ kind = "help", label = "ON: 3rd-person cam auto-zooms in when a wall blocks the view, then eases back out. Keeps auto-follow on the player/HMD." },
			{ kind = "slider", label = "Follow-cam min distance", cvar = "vrmod_desktop_cam_min_dist", min = 8, max = 80, decimals = 0 },
			{ kind = "slider", label = "Follow-cam wall pad", cvar = "vrmod_desktop_cam_collide_pad", min = 1, max = 16, decimals = 0 },
			...
			{ kind = "help", label = "Reset distance/height/FOV/orbit/smooth/wall-zoom to defaults (behind HMD, auto orbit off)." },
	...
	},
	{
		...
		rows = {
			...
			{ kind = "bool", label = "Head / HMD wall block", cvar = "vrmod_head_collision" },
			...
			{ kind = "slider", label = "Head collision radius", cvar = "vrmod_head_collision_radius", min = 3, max = 14, decimals = 1 },
